...
def getDataset():
    # Default transforms for pretrained VGG19
...
def model_train(model, train_dataset, valid_dataset, num_epochs=50, patience=3):
    ...
    print("\n\nTraining complete. Best model saved as 'vgg19.pth'", flush=True)
    return model
...
if __name__ == "__main__":
    ...
    print("Creating VGG19 model...", flush=True)
    ...
    print("Training VGG19 model...", flush=True)
