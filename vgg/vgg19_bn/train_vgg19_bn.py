...
def getDataset():
    # Default transforms for pretrained VGG19_BN
...
def model_train(model, train_dataset, valid_dataset, num_epochs=50, patience=3):
    ...
    print("\n\nTraining complete. Best model saved as 'vgg19_bn.pth'", flush=True)
    return model
...
if __name__ == "__main__":
    ...
    print("Creating VGG19_BN model...", flush=True)
    ...
    print("Training VGG19_BN model...", flush=True)
