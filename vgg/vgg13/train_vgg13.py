...
def getDataset():
    # Default transforms for pretrained VGG13
    transform = VGG13_Weights.IMAGENET1K_V1.transforms()
...
def model_train(model, train_dataset, valid_dataset, num_epochs=50, patience=3):
    ...
    print("\n\nTraining complete. Best model saved as 'vgg13.pth'", flush=True)
    return model
...
if __name__ == "__main__":
    ...
    print("Creating VGG13 model...", flush=True)
    ...
    print("Training VGG13 model...", flush=True)
