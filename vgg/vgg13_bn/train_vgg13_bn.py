...
def getDataset():
    # Default transforms for pretrained VGG13_BN
...
def model_train(model, train_dataset, valid_dataset, num_epochs=50, patience=3):
    ...
    for epoch in range(num_epochs):
        ...
        if valid_loss < best_valid_loss:
            ...
            epochs_no_improve = 0
            torch.save(model.state_dict(), 'vgg13_bn.pth')
        else:
            epochs_no_improve += 1
    ...
    print("\n\nTraining complete. Best model saved as 'vgg13_bn.pth'", flush=True)
    return model
...
if __name__ == "__main__":
    ...
    print("Creating VGG13_BN model...", flush=True)
    ...
    print("Training VGG13_BN model...", flush=True)
